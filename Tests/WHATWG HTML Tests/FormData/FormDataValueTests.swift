...
@Suite struct `FormData Value Tests` {
    ...
    @Test func `Value string case stores value`() {
        let value = WHATWG_HTML.Attribute.Form.Data.Value.string("hello")
    ...
    @Test func `Value ExpressibleByStringLiteral creates string value`() {
        let value: WHATWG_HTML.Attribute.Form.Data.Value = "test string"
    ...
    @Test func `Value description for string returns the string`() {
        let value = WHATWG_HTML.Attribute.Form.Data.Value.string("hello world")
    ...
    @Test func `Value conforms to Hashable`() {
        let value1 = WHATWG_HTML.Attribute.Form.Data.Value.string("test")
        let value2 = WHATWG_HTML.Attribute.Form.Data.Value.string("test")
    ...
    @Test func `Different string values are not equal`() {
        let value1 = WHATWG_HTML.Attribute.Form.Data.Value.string("hello")
        let value2 = WHATWG_HTML.Attribute.Form.Data.Value.string("world")
    ...
    @Test func `Value conforms to Sendable`() {
        ...
        let value = WHATWG_HTML.Attribute.Form.Data.Value.string("test")
