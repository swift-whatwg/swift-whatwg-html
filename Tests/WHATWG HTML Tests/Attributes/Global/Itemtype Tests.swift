...
@Suite struct `Itemtype Test` {
    ...
    @Test func `Itemtype should support SchemaOrg initialization`() {
        let itemtype = WHATWG_HTML.Attribute.Itemtype(schemaOrg: "Person")
        #expect(itemtype.rawValue == "https://schema.org/Person")
    }
}
