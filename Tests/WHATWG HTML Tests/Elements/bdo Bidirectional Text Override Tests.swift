...
@Suite struct `Bidirectional Text Override Tests` {
    ...
    @Test func `BDO element conforms to HTMLElement`() {
        let bdo = WHATWG_HTML.Element.BidirectionalTextOverride(dir: .rtl)
    ...
    @Suite struct `Direction Attribute Tests` {
        ...
        @Test func `BDO with auto direction`() {
            let bdo = WHATWG_HTML.Element.BidirectionalTextOverride(dir: .auto)
    ...
    @Suite struct `Integration Tests` {
        ...
        @Test func `Multiple BDO elements with different directions`() {
            let ltrBdo = WHATWG_HTML.Element.BidirectionalTextOverride(dir: .ltr)
            let rtlBdo = WHATWG_HTML.Element.BidirectionalTextOverride(dir: .rtl)
            let autoBdo = WHATWG_HTML.Element.BidirectionalTextOverride(dir: .auto)
        ...
        @Test func `Nested direction overrides`() {
            let outerBdo = WHATWG_HTML.Element.BidirectionalTextOverride(dir: .rtl)
            let innerBdo = WHATWG_HTML.Element.BidirectionalTextOverride(dir: .ltr)
    ...
    @Suite struct `Technical Specifications` {
        ...
        @Test func `Direction attribute values correctness`() {
            let ltrDir = WHATWG_HTML.Attribute.Dir.ltr
            let rtlDir = WHATWG_HTML.Attribute.Dir.rtl
            let autoDir = WHATWG_HTML.Attribute.Dir.auto
