...
@Suite struct `Bigger Text Tests` {
    ...
    @Test func `Basic Big element creation`() {
        let big = WHATWG.HTML.Element.Big()
        #expect(WHATWG.HTML.Element.Big.tag == "big")
    }

    @Test func `Big element conforms to HTMLElement`() {
        let big = WHATWG.HTML.Element.Big()
        let element: any WHATWG.HTML.Element.`Protocol` = big
    ...
    @Suite struct `Integration Tests` {
        ...
        @Test func `Multiple Big elements`() {
            let big1 = WHATWG.HTML.Element.Big()
            let big2 = WHATWG.HTML.Element.Big()
            let big3 = WHATWG.HTML.Element.Big()
        ...
        @Test func `Nested Big elements`() {
            let outerBig = WHATWG.HTML.Element.Big()
            let innerBig = WHATWG.HTML.Element.Big()

            #expect(WHATWG.HTML.Element.Big.tag == "big")
            #expect(outerBig is any WHATWG.HTML.Element.`Protocol`)
            #expect(innerBig is any WHATWG.HTML.Element.`Protocol`)
        }
