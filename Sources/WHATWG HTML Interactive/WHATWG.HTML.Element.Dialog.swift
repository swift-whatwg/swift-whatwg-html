...
extension WHATWG.HTML.Element {
    ...
    ///
    public struct Dialog: WHATWG.HTML.Element.`Protocol` {
...
extension WHATWG.HTML.Element.Dialog {
    /// The HTML tag name
