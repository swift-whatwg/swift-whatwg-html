...
extension WHATWG.HTML.Attribute {
    ...
    public struct RowSpan: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.RowSpan {
...
extension WHATWG.HTML.Attribute.RowSpan: ExpressibleByIntegerLiteral {
