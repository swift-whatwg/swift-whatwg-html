...
extension WHATWG.HTML.Attribute {
    ...
    @dynamicMemberLookup public struct ColSpan: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.ColSpan {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "colspan" }
}

extension WHATWG.HTML.Attribute.ColSpan: ExpressibleByIntegerLiteral {
