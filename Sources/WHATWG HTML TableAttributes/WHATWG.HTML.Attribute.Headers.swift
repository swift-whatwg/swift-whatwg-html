...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct Headers: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Headers {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "headers" }
}

extension WHATWG.HTML.Attribute.Headers: ExpressibleByArrayLiteral {
