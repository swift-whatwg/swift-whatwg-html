...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct Rows: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Rows {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "rows" }
}

extension WHATWG.HTML.Attribute.Rows: ExpressibleByIntegerLiteral {
