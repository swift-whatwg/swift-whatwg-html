...
extension WHATWG.HTML.Attribute {
    ...
    public struct Download: WHATWG.HTML.Attribute.`Protocol`, CustomStringConvertible {
...
extension WHATWG.HTML.Attribute.Download {
...
extension WHATWG.HTML.Attribute.Download: ExpressibleByBooleanLiteral {
...
extension WHATWG.HTML.Attribute.Download: ExpressibleByStringLiteral {
