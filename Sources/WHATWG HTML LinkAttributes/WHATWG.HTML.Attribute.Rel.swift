...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct Rel: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Rel {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "rel" }
}

extension WHATWG.HTML.Attribute.Rel: ExpressibleByArrayLiteral {
...
extension WHATWG.HTML.Attribute.Rel {
    ...
    public static let secureExternal: Self = .init([
        WHATWG.HTML.Attribute.Rel.external, .noopener, .noreferrer,
    ])
}

extension WHATWG.HTML.Attribute.Rel {
    public init(_ rels: [WHATWG.HTML.Attribute.Rel]) {
