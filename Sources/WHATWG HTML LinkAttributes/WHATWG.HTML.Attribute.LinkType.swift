...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct LinkType: WHATWG.HTML.StringAttribute {
        /// The attribute value
...
extension WHATWG.HTML.Attribute.LinkType {
...
extension WHATWG.HTML.Attribute.LinkType {
    ...
    public static let css = WHATWG.HTML.Attribute.LinkType(contentType: .textCSS)

    /// text/javascript - JavaScript
    public static let javascript = WHATWG.HTML.Attribute.LinkType(contentType: .textJavaScript)

    /// image/x-icon - Favicon
    public static let icon = WHATWG.HTML.Attribute.LinkType(contentType: .imageXIcon)

    /// image/svg+xml - SVG image
    public static let svg = WHATWG.HTML.Attribute.LinkType(contentType: .imageSVG)

    /// image/png - PNG image
    public static let png = WHATWG.HTML.Attribute.LinkType(contentType: .imagePNG)

    /// application/manifest+json - Web app manifest
    public static let manifest = WHATWG.HTML.Attribute.LinkType(
        contentType: .applicationManifestJSON
    )

    /// application/rss+xml - RSS feed
    public static let rss = WHATWG.HTML.Attribute.LinkType(contentType: .applicationRSSXML)

    /// application/atom+xml - Atom feed
    public static let atom = WHATWG.HTML.Attribute.LinkType(contentType: .applicationAtomXML)

    /// application/json - JSON data
    public static let json = WHATWG.HTML.Attribute.LinkType(contentType: .applicationJSON)
}
