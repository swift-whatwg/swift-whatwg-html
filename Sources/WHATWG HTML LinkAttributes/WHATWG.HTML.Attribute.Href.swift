...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct Href: WHATWG.HTML.StringAttribute {
        /// The attribute value
...
extension WHATWG.HTML.Attribute.Href {
...
extension WHATWG.HTML.Attribute.Href {
    ...
    public static func tel(_ phoneNumber: String) -> WHATWG.HTML.Attribute.Href {
        return WHATWG.HTML.Attribute.Href(value: "tel:\(phoneNumber)")
    }

    /// Create an Href for an email address
    /// - Parameter email: The email address
    /// - Returns: An Href with a mailto: scheme
    public static func mailto(_ email: String) -> WHATWG.HTML.Attribute.Href {
        return WHATWG.HTML.Attribute.Href(value: "mailto:\(email)")
    }

    /// Create an Href for SMS
    /// - Parameter phoneNumber: The phone number to send SMS to
    /// - Returns: An Href with an sms: scheme
    public static func sms(_ phoneNumber: String) -> WHATWG.HTML.Attribute.Href {
        return WHATWG.HTML.Attribute.Href(value: "sms:\(phoneNumber)")
    }

    /// Create an Href for a file URL
    /// - Parameter path: The file path
    /// - Returns: An Href with a file: scheme
    public static func file(_ path: String) -> WHATWG.HTML.Attribute.Href {
        return WHATWG.HTML.Attribute.Href(value: "file://\(path)")
    }
    ...
    public static func fragment(_ fragment: String) -> WHATWG.HTML.Attribute.Href {
        return WHATWG.HTML.Attribute.Href(value: "#\(fragment)")
    }
    ...
    public static func whatsapp(_ phoneNumber: String) -> WHATWG.HTML.Attribute.Href {
        return WHATWG.HTML.Attribute.Href(value: "https://wa.me/\(phoneNumber)")
    }

    /// Create an Href for FaceTime
    /// - Parameter contact: Phone number or email address
    /// - Returns: An Href with a facetime: scheme
    public static func facetime(_ contact: String) -> WHATWG.HTML.Attribute.Href {
        return WHATWG.HTML.Attribute.Href(value: "facetime:\(contact)")
    }

    /// Create an Href for FaceTime video call
    /// - Parameter contact: Phone number or email address
    /// - Returns: An Href with a facetime-video: scheme
    public static func facetimeVideo(_ contact: String) -> WHATWG.HTML.Attribute.Href {
        return WHATWG.HTML.Attribute.Href(value: "facetime-video:\(contact)")
    }
}
...
extension WHATWG.HTML.Attribute.Href {
    ...
    public static func fragment(_ base: String, fragment: String) -> WHATWG.HTML.Attribute.Href {
        ...
        return WHATWG.HTML.Attribute.Href("\(baseWithoutFragment)#\(fragmentWithoutHash)")
    }

    /// Creates a link to a specific fragment on the current page
    public static func anchor(_ fragmentId: String) -> WHATWG.HTML.Attribute.Href {
        let fragmentWithoutHash = fragmentId.hasPrefix("#") ? fragmentId : "#\(fragmentId)"
        return WHATWG.HTML.Attribute.Href(fragmentWithoutHash)
    }
    ...
    public static func email(
        ...
        return WHATWG.HTML.Attribute.Href(url)
    }
