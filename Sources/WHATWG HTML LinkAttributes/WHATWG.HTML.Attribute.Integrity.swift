...
extension WHATWG.HTML.Attribute {
    ...
    ///
    @dynamicMemberLookup public struct Integrity: WHATWG.HTML.StringAttribute {
        /// The attribute value
...
extension WHATWG.HTML.Attribute.Integrity {
...
extension WHATWG.HTML.Attribute.Integrity {
    ...
    public static func sha256(_ hash: String) -> WHATWG.HTML.Attribute.Integrity {
        return WHATWG.HTML.Attribute.Integrity("sha256-\(hash)")
    }

    /// Creates an integrity hash using the SHA-384 algorithm
    public static func sha384(_ hash: String) -> WHATWG.HTML.Attribute.Integrity {
        return WHATWG.HTML.Attribute.Integrity("sha384-\(hash)")
    }

    /// Creates an integrity hash using the SHA-512 algorithm
    public static func sha512(_ hash: String) -> WHATWG.HTML.Attribute.Integrity {
        return WHATWG.HTML.Attribute.Integrity("sha512-\(hash)")
    }
}
