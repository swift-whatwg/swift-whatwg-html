...
extension WHATWG.HTML.Attribute {
    ...
    @dynamicMemberLookup public struct FetchPriority: WHATWG.HTML.StringAttribute {
        /// The attribute value
...
extension WHATWG.HTML.Attribute.FetchPriority {
...
extension WHATWG.HTML.Attribute.FetchPriority: CaseIterable {
    public static let allCases: [WHATWG.HTML.Attribute.FetchPriority] = [.high, .low, .auto]
}
