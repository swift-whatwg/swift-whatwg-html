...
extension WHATWG_HTML.Attribute {
    ...
    public struct Download: WHATWG_HTML.Attribute.`Protocol`, CustomStringConvertible {
...
extension WHATWG_HTML.Attribute.Download {
...
extension WHATWG_HTML.Attribute.Download: ExpressibleByBooleanLiteral {
...
extension WHATWG_HTML.Attribute.Download: ExpressibleByStringLiteral {
