...
extension WHATWG.HTML.Attribute {
    @dynamicMemberLookup public struct Ping: WHATWG.HTML.StringAttribute {
        /// The attribute value
...
extension WHATWG.HTML.Attribute.Ping {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "ping" }
}

extension WHATWG.HTML.Attribute.Ping: ExpressibleByArrayLiteral {
