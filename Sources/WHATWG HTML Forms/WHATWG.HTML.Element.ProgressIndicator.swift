...
extension WHATWG.HTML.Element {
    ...
    ///
    public struct ProgressIndicator: WHATWG.HTML.Element.`Protocol` {
        ...
        public var value: WHATWG.HTML.Attribute.Value<Float>?
        ...
        public init(
            ...
            value: WHATWG.HTML.Attribute.Value<Float>? = nil
        ) {
            self.max = max
            self.value = value
...
extension WHATWG.HTML.Element.ProgressIndicator {
    /// The HTML tag name
