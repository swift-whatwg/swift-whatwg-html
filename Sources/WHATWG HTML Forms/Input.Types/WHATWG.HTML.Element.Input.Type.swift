...
extension WHATWG.HTML.Element.Input {
    ...
    public enum Variant: Sendable, Hashable {
        ...
        case button(WHATWG.HTML.Element.Input.Button)

        /// A check box allowing single values to be selected/deselected.
        case checkbox(WHATWG.HTML.Element.Input.Checkbox)

        /// A control for specifying a color; opening a color picker when active in supporting browsers.
        case color(WHATWG.HTML.Element.Input.Color)
        ...
        case date(WHATWG.HTML.Element.Input.Date)
        ...
        case datetimeLocal(WHATWG.HTML.Element.Input.DatetimeLocal)

        /// A field for editing an email address. Looks like a text input, but has validation parameters and relevant keyboard in supporting browsers and devices with dynamic keyboards.
        case email(WHATWG.HTML.Element.Input.Email)

        /// A control that lets the user select a file. Use the accept attribute to define the types of files that the control can select.
        case file(WHATWG.HTML.Element.Input.File)
        ...
        case hidden(WHATWG.HTML.Element.Input.Hidden)
        ...
        case image(WHATWG.HTML.Element.Input.Image)

        /// A control for entering a month and year, with no time zone.
        case month(WHATWG.HTML.Element.Input.Month)
        ...
        case number(WHATWG.HTML.Element.Input.Number)

        /// A single-line text field whose value is obscured. Will alert user if site is not secure.
        case password(WHATWG.HTML.Element.Input.Password)

        /// A radio button, allowing a single value to be selected out of multiple choices with the same name value.
        case radio(WHATWG.HTML.Element.Input.Radio)
        ...
        case range(WHATWG.HTML.Element.Input.Range)

        /// A button that resets the contents of the form to default values. Not recommended.
        case reset(WHATWG.HTML.Element.Input.Reset)
        ...
        case url(WHATWG.HTML.Element.Input.Url)

        /// A control for entering a date consisting of a week-year number and a week number with no time zone.
        case week(WHATWG.HTML.Element.Input.Week)
...
extension WHATWG.HTML.Element.Input.Variant {
...
extension WHATWG.HTML.Element.Input.`Type` {
