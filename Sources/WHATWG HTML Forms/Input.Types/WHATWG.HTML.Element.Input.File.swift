...
extension WHATWG.HTML.Element.Input {
    public struct File: Sendable, Hashable {
        ...
        public var capture: WHATWG.HTML.Attribute.Capture?

        /// When the multiple Boolean attribute is specified, the file input allows the user to select
        /// more than one file.
        public var multiple: WHATWG.HTML.Attribute.Multiple?

        public var required: WHATWG.HTML.Attribute.Required?

        /// Creates a new file input configuration
        public init(
            accept: WHATWG.HTML.Attribute.Accept? = nil,
            capture: WHATWG.HTML.Attribute.Capture? = nil,
            multiple: WHATWG.HTML.Attribute.Multiple? = nil,
