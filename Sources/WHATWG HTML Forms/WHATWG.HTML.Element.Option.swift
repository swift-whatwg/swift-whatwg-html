...
extension WHATWG.HTML.Element {
    ...
    ///
    public struct Option: WHATWG.HTML.Element.`Protocol` {
        ...
        public var selected: WHATWG.HTML.Attribute.Selected?
        ...
        public init(
            ...
            selected: WHATWG.HTML.Attribute.Selected? = nil,
            value: WHATWG.HTML.Attribute.Value<String>
        ) {
