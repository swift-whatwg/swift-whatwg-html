...
extension WHATWG.HTML.Attribute {
    @dynamicMemberLookup
    public struct MarginWidth: WHATWG.HTML.StringAttribute, ExpressibleByIntegerLiteral {
...
extension WHATWG.HTML.Attribute.MarginWidth {
...
//    public struct Margin: WHATWG.HTML.StringAttribute {
