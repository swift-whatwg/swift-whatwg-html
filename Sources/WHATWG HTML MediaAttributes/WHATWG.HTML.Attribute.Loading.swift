...
extension WHATWG.HTML.Attribute {
    ...
    @dynamicMemberLookup public struct Loading: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Loading {
...
extension WHATWG.HTML.Attribute.Loading: CaseIterable {
    public static let allCases: [WHATWG.HTML.Attribute.Loading] = [.lazy, .eager]
}
