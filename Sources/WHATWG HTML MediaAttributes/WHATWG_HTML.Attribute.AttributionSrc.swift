...
extension WHATWG_HTML.Attribute {
    ...
    ///   in all browsers.
    public struct AttributionSrc: WHATWG_HTML.Attribute.`Protocol`, CustomStringConvertible {
...
extension WHATWG_HTML.Attribute.AttributionSrc {
...
extension WHATWG_HTML.Attribute.AttributionSrc: ExpressibleByBooleanLiteral {
...
extension WHATWG_HTML.Attribute.AttributionSrc: ExpressibleByStringLiteral {
