...
extension WHATWG.HTML.Attribute {
    ...
    /// </map>
    /// ```
    @dynamicMemberLookup public struct Usemap: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Usemap {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "usemap" }
}

extension WHATWG.HTML.Attribute.Usemap: ExpressibleByStringLiteral {
