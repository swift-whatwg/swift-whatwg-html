...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct ObjectType: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.ObjectType {
...
extension WHATWG.HTML.Attribute.ObjectType {
    /// application/pdf
    public static let pdf = WHATWG.HTML.Attribute.ObjectType(contentType: .applicationPDF)

    /// video/mp4
    public static let mp4 = WHATWG.HTML.Attribute.ObjectType(contentType: .videoMP4)

    /// audio/mpeg (MP3)
    public static let mp3 = WHATWG.HTML.Attribute.ObjectType(contentType: .audioMPEG)

    /// image/jpeg
    public static let jpeg = WHATWG.HTML.Attribute.ObjectType(contentType: .imageJPEG)

    /// image/png
    public static let png = WHATWG.HTML.Attribute.ObjectType(contentType: .imagePNG)

    /// text/html
    public static let html = WHATWG.HTML.Attribute.ObjectType(contentType: .textHTML)
}
