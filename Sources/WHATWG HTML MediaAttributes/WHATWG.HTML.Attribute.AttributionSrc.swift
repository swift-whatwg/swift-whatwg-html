...
extension WHATWG.HTML.Attribute {
    ...
    ///   in all browsers.
    public struct AttributionSrc: WHATWG.HTML.Attribute.`Protocol`, CustomStringConvertible {
...
extension WHATWG.HTML.Attribute.AttributionSrc {
...
extension WHATWG.HTML.Attribute.AttributionSrc: ExpressibleByBooleanLiteral {
...
extension WHATWG.HTML.Attribute.AttributionSrc: ExpressibleByStringLiteral {
