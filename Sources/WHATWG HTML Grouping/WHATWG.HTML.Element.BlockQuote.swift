...
extension WHATWG.HTML.Element {
    ...
    ///
    public struct BlockQuote: WHATWG.HTML.Element.`Protocol` {
        ...
        public init(cite: WHATWG.HTML.Attribute.Cite? = nil) { self.cite = cite }
    }
}

extension WHATWG.HTML.Element.BlockQuote {
    /// The HTML tag name
