...
extension WHATWG.HTML.Element {
    ...
    ///
    public struct ListItem: WHATWG.HTML.Element.`Protocol` {
        ...
        public var value: WHATWG.HTML.Attribute.Value<Int>?
        ...
        public init(value: WHATWG.HTML.Attribute.Value<Int>? = nil) {
            self.value = value
...
extension WHATWG.HTML.Element.ListItem {
    /// The HTML tag name
