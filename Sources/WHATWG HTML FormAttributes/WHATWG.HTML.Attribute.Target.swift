...
extension WHATWG.HTML.Attribute {
    ...
    /// }
    /// ```
    @dynamicMemberLookup public struct Target: WHATWG.HTML.StringAttribute {
        /// The target value
...
extension WHATWG.HTML.Attribute.Target {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "target" }
}

extension WHATWG.HTML.Attribute.Target: ExpressibleByStringLiteral {
