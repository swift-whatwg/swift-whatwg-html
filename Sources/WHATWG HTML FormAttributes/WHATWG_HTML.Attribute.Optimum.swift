...
extension WHATWG_HTML.Attribute {
    ...
    /// ```
    public struct Optimum: WHATWG_HTML.Attribute.`Protocol`, CustomStringConvertible {
        /// The attribute value
...
extension WHATWG_HTML.Attribute.Optimum {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "optimum" }
}

extension WHATWG_HTML.Attribute.Optimum: ExpressibleByFloatLiteral {
    public init(floatLiteral value: FloatLiteralType) { self.value = value }
}

extension WHATWG_HTML.Attribute.Optimum: ExpressibleByIntegerLiteral {
