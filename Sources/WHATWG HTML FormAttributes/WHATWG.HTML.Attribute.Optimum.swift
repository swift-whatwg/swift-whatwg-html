...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    public struct Optimum: WHATWG.HTML.Attribute.`Protocol`, CustomStringConvertible {
        /// The attribute value
...
extension WHATWG.HTML.Attribute.Optimum {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "optimum" }
}

extension WHATWG.HTML.Attribute.Optimum: ExpressibleByFloatLiteral {
    public init(floatLiteral value: FloatLiteralType) { self.value = value }
}

extension WHATWG.HTML.Attribute.Optimum: ExpressibleByIntegerLiteral {
