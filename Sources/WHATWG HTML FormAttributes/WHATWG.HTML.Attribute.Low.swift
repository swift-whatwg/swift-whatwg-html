...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    public struct Low: WHATWG.HTML.Attribute.`Protocol`, CustomStringConvertible {
        /// The attribute value
...
extension WHATWG.HTML.Attribute.Low {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "low" }
}

extension WHATWG.HTML.Attribute.Low: ExpressibleByFloatLiteral {
    public init(floatLiteral value: Double) { self.value = value }
}

extension WHATWG.HTML.Attribute.Low: ExpressibleByIntegerLiteral {
