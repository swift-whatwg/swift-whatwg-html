...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct Min: WHATWG.HTML.StringAttribute {
        /// The attribute value
...
extension WHATWG.HTML.Attribute.Min {
...
extension WHATWG.HTML.Attribute.Min {
    ...
    public static let zero = WHATWG.HTML.Attribute.Min(0)
}

extension WHATWG.HTML.Attribute.Min: ExpressibleByIntegerLiteral {
    public init(integerLiteral value: IntegerLiteralType) { self.rawValue = String(value) }
}

extension WHATWG.HTML.Attribute.Min: ExpressibleByFloatLiteral {
    public init(floatLiteral value: FloatLiteralType) { self.rawValue = String(value) }
}

extension WHATWG.HTML.Attribute.Min {
    /// Create a min value for a date input
    public static func date(_ year: Int, month: Int, day: Int) -> WHATWG.HTML.Attribute.Min {
        return WHATWG.HTML.Attribute.Min(String.format(year: year, month: month, day: day))
    }

    /// Create a min value for a month input
    public static func month(_ year: Int, month: Int) -> WHATWG.HTML.Attribute.Min {
        return WHATWG.HTML.Attribute.Min(String.format(year: year, month: month))
    }

    /// Create a min value for a week input
    public static func week(_ year: Int, week: Int) -> WHATWG.HTML.Attribute.Min {
        return WHATWG.HTML.Attribute.Min(String.format(year: year, week: week))
    }

    /// Create a min value for a time input
    public static func time(_ hour: Int, minute: Int) -> WHATWG.HTML.Attribute.Min {
        return WHATWG.HTML.Attribute.Min(String.format(hour: hour, minute: minute))
    }
    ...
    public static func dateTimeLocal(
        ...
        hour: Int,
        minute: Int
    ) -> WHATWG.HTML.Attribute.Min {
        return WHATWG.HTML.Attribute.Min(
