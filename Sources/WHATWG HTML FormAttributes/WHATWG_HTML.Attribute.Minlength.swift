...
extension WHATWG_HTML.Attribute {
    ...
    /// ```
    public struct Minlength: WHATWG_HTML.Attribute.`Protocol` {
...
extension WHATWG_HTML.Attribute.Minlength {
...
extension WHATWG_HTML.Attribute.Minlength: CustomStringConvertible {
