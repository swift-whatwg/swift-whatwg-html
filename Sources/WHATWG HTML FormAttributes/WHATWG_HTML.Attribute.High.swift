...
extension WHATWG_HTML.Attribute {
    ...
    /// ```
    public struct High: WHATWG_HTML.Attribute.`Protocol`, CustomStringConvertible {
        /// The attribute value
...
extension WHATWG_HTML.Attribute.High {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "high" }
}

extension WHATWG_HTML.Attribute.High: ExpressibleByFloatLiteral {
    public init(floatLiteral value: Double) { self.value = value }
}

extension WHATWG_HTML.Attribute.High: ExpressibleByIntegerLiteral {
