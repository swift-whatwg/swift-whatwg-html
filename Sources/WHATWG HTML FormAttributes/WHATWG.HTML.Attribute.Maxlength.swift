...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    public struct Maxlength: WHATWG.HTML.Attribute.`Protocol` {
...
extension WHATWG.HTML.Attribute.Maxlength {
...
extension WHATWG.HTML.Attribute.Maxlength {
    ...
    public static func characters(_ count: Int) -> WHATWG.HTML.Attribute.Maxlength {
        return WHATWG.HTML.Attribute.Maxlength(count)
    }
}

extension WHATWG.HTML.Attribute.Maxlength: ExpressibleByIntegerLiteral {
    public init(integerLiteral value: IntegerLiteralType) { self.value = max(0, value) }
}

extension WHATWG.HTML.Attribute.Maxlength: CustomStringConvertible {
