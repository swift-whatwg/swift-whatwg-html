...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct Max: WHATWG.HTML.StringAttribute {
        /// The attribute value
...
extension WHATWG.HTML.Attribute.Max {
...
extension WHATWG.HTML.Attribute.Max: ExpressibleByIntegerLiteral {
    public init(integerLiteral value: IntegerLiteralType) { self.rawValue = String(value) }
}

extension WHATWG.HTML.Attribute.Max: ExpressibleByFloatLiteral {
    public init(floatLiteral value: FloatLiteralType) { self.rawValue = String(value) }
}

extension WHATWG.HTML.Attribute.Max {
    /// Create a max value for a date input
    public static func date(_ year: Int, month: Int, day: Int) -> WHATWG.HTML.Attribute.Max {
        return WHATWG.HTML.Attribute.Max(String.format(year: year, month: month, day: day))
    }

    /// Create a max value for a month input
    public static func month(_ year: Int, month: Int) -> WHATWG.HTML.Attribute.Max {
        return WHATWG.HTML.Attribute.Max(String.format(year: year, month: month))
    }

    /// Create a max value for a week input
    public static func week(_ year: Int, week: Int) -> WHATWG.HTML.Attribute.Max {
        return WHATWG.HTML.Attribute.Max(String.format(year: year, week: week))
    }

    /// Create a max value for a time input
    public static func time(_ hour: Int, minute: Int) -> WHATWG.HTML.Attribute.Max {
        return WHATWG.HTML.Attribute.Max(String.format(hour: hour, minute: minute))
    }
    ...
    public static func dateTimeLocal(
        ...
        hour: Int,
        minute: Int
    ) -> WHATWG.HTML.Attribute.Max {
        return WHATWG.HTML.Attribute.Max(
