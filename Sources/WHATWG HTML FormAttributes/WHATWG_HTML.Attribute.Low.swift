...
extension WHATWG_HTML.Attribute {
    ...
    /// ```
    public struct Low: WHATWG_HTML.Attribute.`Protocol`, CustomStringConvertible {
        /// The attribute value
...
extension WHATWG_HTML.Attribute.Low {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "low" }
}

extension WHATWG_HTML.Attribute.Low: ExpressibleByFloatLiteral {
    public init(floatLiteral value: Double) { self.value = value }
}

extension WHATWG_HTML.Attribute.Low: ExpressibleByIntegerLiteral {
