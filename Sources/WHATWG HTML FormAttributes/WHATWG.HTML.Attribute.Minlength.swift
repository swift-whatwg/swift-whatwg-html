...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    public struct Minlength: WHATWG.HTML.Attribute.`Protocol` {
...
extension WHATWG.HTML.Attribute.Minlength {
    ...
    public static func characters(_ count: Int) -> WHATWG.HTML.Attribute.Minlength {
        return WHATWG.HTML.Attribute.Minlength(count)
    }

    /// Minimum length of zero (effectively no minimum)
    public static let none = WHATWG.HTML.Attribute.Minlength(0)
}

extension WHATWG.HTML.Attribute.Minlength: ExpressibleByIntegerLiteral {
    public init(integerLiteral value: IntegerLiteralType) { self.value = max(0, value) }
}

extension WHATWG.HTML.Attribute.Minlength: CustomStringConvertible {
