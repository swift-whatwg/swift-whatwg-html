...
extension WHATWG.HTML.Attribute {
    ...
    /// </select>
    /// ```
    @dynamicMemberLookup public struct Size: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Size {
...
extension WHATWG.HTML.Attribute.Size {
    ...
    public static let standardTextField = WHATWG.HTML.Attribute.Size(30)

    /// Create a size attribute for a small text field (width for about 10 characters)
    public static let smallTextField = WHATWG.HTML.Attribute.Size(10)

    /// Create a size attribute for a large text field (width for about 50 characters)
    public static let largeTextField = WHATWG.HTML.Attribute.Size(50)

    /// Create a size attribute for a listbox showing multiple options (5 options visible)
    public static let standardListbox = WHATWG.HTML.Attribute.Size(5)
}

extension WHATWG.HTML.Attribute.Size: ExpressibleByIntegerLiteral {
