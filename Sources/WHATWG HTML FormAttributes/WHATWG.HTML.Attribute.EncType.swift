...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct EncType: WHATWG.HTML.StringAttribute {
        /// The attribute value
...
extension WHATWG.HTML.Attribute.EncType {
...
extension WHATWG.HTML.Attribute.EncType {
    ...
    public static let urlEncoded = WHATWG.HTML.Attribute.EncType(
        contentType: .applicationXWWWFormURLEncoded
    )

    /// Required for file uploads - multipart/form-data (RFC 7578)
    public static let multipartFormData = WHATWG.HTML.Attribute.EncType(
        contentType: .multipartFormData()
    )

    /// Minimal encoding, useful for debugging - text/plain
    public static let textPlain = WHATWG.HTML.Attribute.EncType(contentType: .textPlain)
}
