...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    public struct High: WHATWG.HTML.Attribute.`Protocol`, CustomStringConvertible {
        /// The attribute value
...
extension WHATWG.HTML.Attribute.High {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "high" }
}

extension WHATWG.HTML.Attribute.High: ExpressibleByFloatLiteral {
    public init(floatLiteral value: Double) { self.value = value }
}

extension WHATWG.HTML.Attribute.High: ExpressibleByIntegerLiteral {
