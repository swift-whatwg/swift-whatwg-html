...
extension WHATWG_HTML.Attribute {
    ...
    /// </select>
    /// ```
    public struct Value<Element: Sendable & Hashable>: WHATWG_HTML.Attribute.`Protocol` {
...
extension WHATWG_HTML.Attribute.Value: LosslessStringConvertible where Element == String {
...
extension WHATWG_HTML.Attribute.Value: ExpressibleByExtendedGraphemeClusterLiteral
...
extension WHATWG_HTML.Attribute.Value: ExpressibleByUnicodeScalarLiteral
