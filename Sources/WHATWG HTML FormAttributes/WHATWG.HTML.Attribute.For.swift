...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct For: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.For {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "for" }
}

extension WHATWG.HTML.Attribute.For: ExpressibleByArrayLiteral {
