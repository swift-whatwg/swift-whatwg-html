...
extension WHATWG.HTML.Attribute {
    ...
    /// </textarea>
    /// ```
    @dynamicMemberLookup public struct TextareaWrap: WHATWG.HTML.StringAttribute {
        /// The wrap value
...
extension WHATWG.HTML.Attribute.TextareaWrap {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "wrap" }

    /// Line breaks are automatically inserted
    public static let hard = WHATWG.HTML.Attribute.TextareaWrap("hard")

    /// Line breaks are not automatically inserted
    public static let soft = WHATWG.HTML.Attribute.TextareaWrap("soft")
}
