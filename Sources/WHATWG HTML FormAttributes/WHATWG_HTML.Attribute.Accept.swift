...
extension WHATWG_HTML.Attribute {
    ...
    /// ```
    public struct Accept: WHATWG_HTML.Attribute.`Protocol` {
...
extension WHATWG_HTML.Attribute.Accept {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "accept" }
}

extension WHATWG_HTML.Attribute.Accept: ExpressibleByStringLiteral {
    public init(stringLiteral value: String) { self = .init(rawValue: value) }
}

extension WHATWG_HTML.Attribute.Accept: CustomStringConvertible {
...
extension WHATWG_HTML.Attribute.Accept.FileType {
