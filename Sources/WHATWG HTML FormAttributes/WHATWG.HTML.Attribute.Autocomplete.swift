...
extension WHATWG.HTML.Attribute {
    ...
    @dynamicMemberLookup public struct Autocomplete: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Autocomplete {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "autocomplete" }
}

extension WHATWG.HTML.Attribute.Autocomplete: ExpressibleByBooleanLiteral {
...
extension WHATWG.HTML.Attribute.Autocomplete: ExpressibleByArrayLiteral {
...
extension WHATWG.HTML.Attribute.Autocomplete {
    ...
    public static func shipping(_ detailToken: Token.Address) -> WHATWG.HTML.Attribute.Autocomplete
    {
        return WHATWG.HTML.Attribute.Autocomplete([
            Token.grouping(.shipping), Token.address(detailToken),
        ])
    }

    /// Create an autocomplete value for a billing address field
    public static func billing(_ detailToken: Token.Address) -> WHATWG.HTML.Attribute.Autocomplete {
        return WHATWG.HTML.Attribute.Autocomplete([
    ...
    ) -> WHATWG.HTML.Attribute.Autocomplete {
        return WHATWG.HTML.Attribute.Autocomplete([
    ...
    public static func section(
        _ name: String,
        _ tokens: WHATWG.HTML.Attribute.Autocomplete.Token...
    ) -> WHATWG.HTML.Attribute.Autocomplete {
        var allTokens: [WHATWG.HTML.Attribute.Autocomplete.Token] = [Token.section(name)]
        allTokens.append(contentsOf: tokens)
        return WHATWG.HTML.Attribute.Autocomplete(allTokens)
    }
}
...
extension WHATWG.HTML.Attribute.Autocomplete {
    ...
    public enum Token {
        ...
        case name(WHATWG.HTML.Attribute.Autocomplete.Token.Name)
...
extension WHATWG.HTML.Attribute.Autocomplete.Token {
