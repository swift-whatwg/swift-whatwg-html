...
extension WHATWG.HTML.Attribute {
    ...
    /// </select>
    /// ```
    public struct Value<Element: Sendable & Hashable>: WHATWG.HTML.Attribute.`Protocol` {
...
extension WHATWG.HTML.Attribute.Value: LosslessStringConvertible where Element == String {
    public init?(_ description: String) { self = .init(description) }
}

extension WHATWG.HTML.Attribute.Value: ExpressibleByStringLiteral
...
extension WHATWG.HTML.Attribute.Value: ExpressibleByExtendedGraphemeClusterLiteral
...
extension WHATWG.HTML.Attribute.Value: ExpressibleByUnicodeScalarLiteral
...
extension WHATWG.HTML.Attribute.Value: ExpressibleByIntegerLiteral
...
extension WHATWG.HTML.Attribute.Value: ExpressibleByFloatLiteral
...
extension WHATWG.HTML.Attribute.Value: CustomStringConvertible
