...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    public struct Accept: WHATWG.HTML.Attribute.`Protocol` {
...
extension WHATWG.HTML.Attribute.Accept {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "accept" }
}

extension WHATWG.HTML.Attribute.Accept: ExpressibleByStringLiteral {
    public init(stringLiteral value: String) { self = .init(rawValue: value) }
}

extension WHATWG.HTML.Attribute.Accept: CustomStringConvertible {
...
extension WHATWG.HTML.Attribute.Accept.FileType {
