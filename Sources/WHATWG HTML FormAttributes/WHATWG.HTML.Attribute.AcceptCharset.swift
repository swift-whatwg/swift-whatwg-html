...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct AcceptCharset: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.AcceptCharset {
...
extension WHATWG.HTML.Attribute.AcceptCharset {
    ...
    public static let utf8: WHATWG.HTML.Attribute.AcceptCharset = "UTF-8"

    /// ISO Latin-1 encoding
    public static let latin1: WHATWG.HTML.Attribute.AcceptCharset = "ISO-8859-1"

    /// ASCII encoding
    public static let ascii: WHATWG.HTML.Attribute.AcceptCharset = "US-ASCII"

    /// Windows-1252 encoding (commonly used in Western European countries)
    public static let windows1252: WHATWG.HTML.Attribute.AcceptCharset = "windows-1252"

    /// UTF-8 and ISO Latin-1 encodings
    public static let utf8AndLatin1: WHATWG.HTML.Attribute.AcceptCharset = "UTF-8,ISO-8859-1"
}
