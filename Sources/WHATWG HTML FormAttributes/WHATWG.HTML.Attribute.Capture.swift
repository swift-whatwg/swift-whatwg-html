...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct Capture: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Capture {
...
extension WHATWG.HTML.Attribute.Capture {
    ...
    public static let user: WHATWG.HTML.Attribute.Capture = "user"

    /// Convenience initializer for "environment" value (back-facing camera)
    public static let environment: WHATWG.HTML.Attribute.Capture = "environment"
}
