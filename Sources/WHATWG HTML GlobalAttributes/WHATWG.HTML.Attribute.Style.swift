...
extension WHATWG.HTML.Attribute {
    ...
    @dynamicMemberLookup public struct Style: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Style {
...
extension WHATWG.HTML.Attribute.Style: ExpressibleByDictionaryLiteral {
