...
extension WHATWG.HTML.Attribute {
    ...
    /// </ol>
    /// ```
    @dynamicMemberLookup public struct Start: WHATWG.HTML.StringAttribute {
        /// The attribute value
...
extension WHATWG.HTML.Attribute.Start {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "start" }
}

extension WHATWG.HTML.Attribute.Start: ExpressibleByIntegerLiteral {
