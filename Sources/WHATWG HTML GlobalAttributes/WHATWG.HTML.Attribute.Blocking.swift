...
extension WHATWG.HTML.Attribute {
    ...
    /// </style>
    /// ```
    @dynamicMemberLookup public struct Blocking: WHATWG.HTML.StringAttribute {
        /// The attribute value
...
extension WHATWG.HTML.Attribute.Blocking {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "blocking" }
}

extension WHATWG.HTML.Attribute.Blocking { @inlinable public static var render: Self { "render" } }
