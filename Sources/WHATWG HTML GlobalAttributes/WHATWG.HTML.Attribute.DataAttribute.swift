...
extension WHATWG.HTML.Attribute {
    ...
    ///      data-y="85160" />
    /// ```
    public struct DataAttribute: WHATWG.HTML.Attribute.`Protocol` {
...
extension WHATWG.HTML.Attribute.DataAttribute {
...
extension WHATWG.HTML.Attribute.DataAttribute: CustomStringConvertible {
