...
extension WHATWG.HTML.Attribute {
    ...
    /// </div>
    /// ```
    @dynamicMemberLookup public struct Itemtype: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Itemtype {
...
extension WHATWG.HTML.Attribute.Itemtype: ExpressibleByArrayLiteral {
