...
extension WHATWG.HTML.Attribute {
    ...
    /// </div>
    /// ```
    @dynamicMemberLookup public struct Draggable: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Draggable {
...
extension WHATWG.HTML.Attribute.Draggable: CaseIterable {
    public static let allCases: [WHATWG.HTML.Attribute.Draggable] = [.true, .false, .auto]
}

extension WHATWG.HTML.Attribute.Draggable: ExpressibleByBooleanLiteral {
