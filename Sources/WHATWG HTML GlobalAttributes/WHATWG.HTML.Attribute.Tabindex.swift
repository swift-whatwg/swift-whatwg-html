...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    public struct Tabindex: WHATWG.HTML.Attribute.`Protocol` {
        /// The tabindex value
...
extension WHATWG.HTML.Attribute.Tabindex {
...
extension WHATWG.HTML.Attribute.Tabindex {
    ...
    public static let notTabbable = WHATWG.HTML.Attribute.Tabindex(-1)

    /// A constant for the common 0 value (in natural tab order)
    public static let inDocumentOrder = WHATWG.HTML.Attribute.Tabindex(0)
}

extension WHATWG.HTML.Attribute.Tabindex: CustomStringConvertible {
