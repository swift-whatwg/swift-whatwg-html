...
extension WHATWG.HTML.Attribute {
    ...
    /// }
    /// ```
    public struct Exportparts: WHATWG.HTML.Attribute.`Protocol` {
...
extension WHATWG.HTML.Attribute.Exportparts {
...
extension WHATWG.HTML.Attribute.Exportparts.PartMapping {
...
extension WHATWG.HTML.Attribute.Exportparts: CustomStringConvertible {
