...
extension WHATWG.HTML.Attribute {
    ...
    /// </div>
    /// ```
    @dynamicMemberLookup public struct Itemref: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Itemref {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "itemref" }
}

extension WHATWG.HTML.Attribute.Itemref: ExpressibleByArrayLiteral {
