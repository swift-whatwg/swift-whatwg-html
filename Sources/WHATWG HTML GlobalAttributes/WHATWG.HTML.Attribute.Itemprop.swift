...
extension WHATWG.HTML.Attribute {
    ...
    /// </div>
    /// ```
    @dynamicMemberLookup public struct Itemprop: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Itemprop {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "itemprop" }
}

extension WHATWG.HTML.Attribute.Itemprop: ExpressibleByArrayLiteral {
