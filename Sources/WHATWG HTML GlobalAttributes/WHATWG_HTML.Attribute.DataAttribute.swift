...
extension WHATWG_HTML.Attribute {
    ...
    ///      data-y="85160" />
    /// ```
    public struct DataAttribute: WHATWG_HTML.Attribute.`Protocol` {
...
extension WHATWG_HTML.Attribute.DataAttribute {
...
extension WHATWG_HTML.Attribute.DataAttribute: CustomStringConvertible {
