...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    ///
    @dynamicMemberLookup public struct Autocapitalize: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Autocapitalize {
...
extension WHATWG.HTML.Attribute.Autocapitalize: CaseIterable {
