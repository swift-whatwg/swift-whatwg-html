...
extension WHATWG.HTML.Attribute {
    ...
    /// </div>
    /// ```
    @dynamicMemberLookup public struct Part: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Part {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "part" }
}

extension WHATWG.HTML.Attribute.Part: ExpressibleByArrayLiteral {
