...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct Popover: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Popover {
...
extension WHATWG.HTML.Attribute.Popover: CaseIterable {
    public static let allCases: [WHATWG.HTML.Attribute.Popover] = [.auto, .manual, .hint]
}
