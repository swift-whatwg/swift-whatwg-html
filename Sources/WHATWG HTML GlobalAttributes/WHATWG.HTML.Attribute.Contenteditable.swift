...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct Contenteditable: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Contenteditable {
...
extension WHATWG.HTML.Attribute.Contenteditable: CaseIterable {
    public static let allCases: [WHATWG.HTML.Attribute.Contenteditable] = [
        .true, .empty, .false, .plaintextOnly,
    ]
}

extension WHATWG.HTML.Attribute.Contenteditable: ExpressibleByBooleanLiteral {
