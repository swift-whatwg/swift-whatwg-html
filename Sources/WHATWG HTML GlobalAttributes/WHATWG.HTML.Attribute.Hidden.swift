...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct Hidden: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Hidden {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "hidden" }
}

extension WHATWG.HTML.Attribute.Hidden { public init() { self = .hidden } }
...
extension WHATWG.HTML.Attribute.Hidden: CaseIterable {
    public static let allCases: [WHATWG.HTML.Attribute.Hidden] = [.empty, .hidden, .untilFound]
}
