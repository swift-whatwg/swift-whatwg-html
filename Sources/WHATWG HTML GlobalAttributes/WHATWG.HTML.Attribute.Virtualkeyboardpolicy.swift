...
extension WHATWG.HTML.Attribute {
    ...
    /// </button>
    /// ```
    @dynamicMemberLookup public struct Virtualkeyboardpolicy: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Virtualkeyboardpolicy {
...
extension WHATWG.HTML.Attribute.Virtualkeyboardpolicy: CaseIterable {
    public static let allCases: [WHATWG.HTML.Attribute.Virtualkeyboardpolicy] = [.auto, .manual]
}
