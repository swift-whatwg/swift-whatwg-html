...
extension WHATWG.HTML.Attribute {
    ...
    /// </div>
    /// ```
    @dynamicMemberLookup public struct Title: WHATWG.HTML.StringAttribute {
        /// The title text
...
extension WHATWG.HTML.Attribute.Title {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "title" }
}

extension WHATWG.HTML.Attribute.Title: ExpressibleByArrayLiteral {
