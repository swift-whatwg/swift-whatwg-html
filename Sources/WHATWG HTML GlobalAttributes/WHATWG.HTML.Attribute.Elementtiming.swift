...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct Elementtiming: WHATWG.HTML.StringAttribute {
        /// The attribute value
...
extension WHATWG.HTML.Attribute.Elementtiming {
...
extension WHATWG.HTML.Attribute.Elementtiming.Category {
