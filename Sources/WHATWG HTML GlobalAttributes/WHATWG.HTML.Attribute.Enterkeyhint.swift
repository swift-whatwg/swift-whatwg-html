...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct Enterkeyhint: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Enterkeyhint {
...
extension WHATWG.HTML.Attribute.Enterkeyhint: CaseIterable {
    public static let allCases: [WHATWG.HTML.Attribute.Enterkeyhint] = [
