...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct FontSize: WHATWG.HTML.StringAttribute {
        /// The attribute value
...
extension WHATWG.HTML.Attribute.FontSize {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "size" }
}

extension WHATWG.HTML.Attribute.FontSize: ExpressibleByIntegerLiteral {
