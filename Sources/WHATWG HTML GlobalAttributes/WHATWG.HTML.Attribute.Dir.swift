...
extension WHATWG.HTML.Attribute {
    ...
    /// </div>
    /// ```
    @dynamicMemberLookup public struct Dir: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Dir {
...
extension WHATWG.HTML.Attribute.Dir: CaseIterable {
    public static let allCases: [WHATWG.HTML.Attribute.Dir] = [ltr, rtl, auto]
}
