...
extension WHATWG.HTML.Attribute {
    ...
    /// </div>
    /// ```
    @dynamicMemberLookup public struct Class: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Class {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "class" }
}

extension WHATWG.HTML.Attribute.Class: ExpressibleByArrayLiteral {
