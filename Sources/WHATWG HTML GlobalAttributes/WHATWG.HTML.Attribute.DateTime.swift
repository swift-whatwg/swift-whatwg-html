...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct DateTime: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.DateTime {
...
extension WHATWG.HTML.Attribute.DateTime {
    ...
    public static func date(
        ...
        month: Int,
        day: Int
    ) throws(ISO_8601.Date.Error) -> WHATWG.HTML.Attribute.DateTime {
        let dt = try ISO_8601.DateTime(year: year, month: month, day: day)
        return WHATWG.HTML.Attribute.DateTime(dateTime: dt)
    }
    ...
    public static func yearMonth(year: Int, month: Int) -> WHATWG.HTML.Attribute.DateTime {
        WHATWG.HTML.Attribute.DateTime(
            "\(year.formatted(.decimal.zeroPadded(width: 4)))-\(month.formatted(.decimal.zeroPadded(width: 2)))"
        )
    }

    /// Create a year-only datetime
    public static func year(_ year: Int) -> WHATWG.HTML.Attribute.DateTime {
        WHATWG.HTML.Attribute.DateTime(year.formatted(.decimal.zeroPadded(width: 4)))
    }
    ...
    public static func time(
        ...
        if second > 0 {
            ...
            return WHATWG.HTML.Attribute.DateTime("\(h):\(m):\(s)")
        } else {
            return WHATWG.HTML.Attribute.DateTime("\(h):\(m)")
        }
    }

    /// Create a duration (e.g., "PT2H30M" for 2 hours 30 minutes)
    public static func duration(_ iso8601Duration: String) -> WHATWG.HTML.Attribute.DateTime {
        WHATWG.HTML.Attribute.DateTime(iso8601Duration)
    }
}
