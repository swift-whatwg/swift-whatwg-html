...
extension WHATWG.HTML.Attribute {
    ...
    /// </div>
    /// ```
    @dynamicMemberLookup public struct Writingsuggestions: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Writingsuggestions {
...
extension WHATWG.HTML.Attribute.Writingsuggestions: CaseIterable {
    public static let allCases: [WHATWG.HTML.Attribute.Writingsuggestions] = [.true, .false]
}
