...
extension WHATWG.HTML.Attribute {
    ...
    /// </p>
    /// ```
    @dynamicMemberLookup public struct Translate: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Translate {
...
extension WHATWG.HTML.Attribute.Translate: ExpressibleByBooleanLiteral {
...
extension WHATWG.HTML.Attribute.Translate: CaseIterable {
    public static let allCases: [WHATWG.HTML.Attribute.Translate] = [.yes, .no]
}
