...
extension WHATWG_HTML.Attribute {
    ...
    /// }
    /// ```
    public struct Exportparts: WHATWG_HTML.Attribute.`Protocol` {
...
extension WHATWG_HTML.Attribute.Exportparts {
...
extension WHATWG_HTML.Attribute.Exportparts.PartMapping {
...
extension WHATWG_HTML.Attribute.Exportparts: CustomStringConvertible {
