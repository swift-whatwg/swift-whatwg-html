...
extension WHATWG.HTML.Attribute {
    ...
    @dynamicMemberLookup public struct FrameBorder: WHATWG.HTML.StringAttribute {
        /// The attribute value
...
extension WHATWG.HTML.Attribute.FrameBorder {
    /// The name of the HTML attribute
    @inlinable public static var attribute: String { "frameborder" }
}

extension WHATWG.HTML.Attribute.FrameBorder: ExpressibleByIntegerLiteral {
