...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct Inputmode: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Inputmode {
...
extension WHATWG.HTML.Attribute.Inputmode: CaseIterable {
    public static let allCases: [WHATWG.HTML.Attribute.Inputmode] = [
