...
extension WHATWG.HTML.Attribute {
    ...
    /// ```
    @dynamicMemberLookup public struct Autocorrect: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Autocorrect {
...
extension WHATWG.HTML.Attribute.Autocorrect: CaseIterable {
