...
extension WHATWG.HTML.Element.Content {
...
extension WHATWG.HTML.Element.Content.Model {
    /// Checks if this content model allows a specific category.
    public func allows(category: WHATWG.HTML.Element.Content.Category) -> Bool {
        switch self {
...
extension WHATWG.HTML.Element.Content.Model: ExpressibleByArrayLiteral {
    public init(arrayLiteral elements: WHATWG.HTML.Element.Content.Category...) {
