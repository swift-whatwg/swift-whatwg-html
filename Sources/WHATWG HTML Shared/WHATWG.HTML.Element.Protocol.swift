...
extension WHATWG.HTML.Element {
    public protocol `Protocol`: Sendable, Hashable {
        ...
        static var categories: Set<WHATWG.HTML.Element.Content.Category> { get }
        ...
        //        var categories: Set<WHATWG.HTML.Element.Content.Category> { get }

        /// The content for this element.
        ///
        /// Describes what types of children are allowed within this element.
        static var content: WHATWG.HTML.Element.Content { get }
    }
}
