...
extension WHATWG.HTML.Element {
    ...
    public struct TableColumnGroup: WHATWG.HTML.Element.`Protocol` {
        ...
        public init(span: WHATWG.HTML.Attribute.Span? = nil) {
            self.span = span
...
extension WHATWG.HTML.Element.TableColumnGroup {
    /// The HTML tag name
