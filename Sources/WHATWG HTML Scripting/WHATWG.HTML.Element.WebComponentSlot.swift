...
extension WHATWG.HTML.Element {
    ...
    ///
    public struct WebComponentSlot: WHATWG.HTML.Element.`Protocol` {
        ...
        public init(name: WHATWG.HTML.Attribute.Name? = nil) {
            self.name = name
...
extension WHATWG.HTML.Element.WebComponentSlot {
    /// The HTML tag name
    @inlinable public static var tag: String { "slot" }

    public static let categories: Set<WHATWG.HTML.Element.Content.Category> = [.flow, .phrasing]
