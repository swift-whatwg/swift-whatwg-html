...
extension WHATWG.HTML.Element {
    ...
    public struct Script: WHATWG.HTML.Element.`Protocol` {
        ...
        public var nomodule: WHATWG.HTML.Attribute.Nomodule?
        ...
        public var nonce: WHATWG.HTML.Attribute.Nonce?

        /// For registration with the Attribution Reporting API
        public var attributionsrc: WHATWG.HTML.Attribute.AttributionSrc?
        ...
        public init(
            ...
            async: WHATWG.HTML.Attribute.Async? = nil,
            defer: WHATWG.HTML.Attribute.Defer? = nil,
            type: WHATWG.HTML.Attribute.ScriptType? = nil,
            integrity: WHATWG.HTML.Attribute.Integrity? = nil,
            referrerpolicy: WHATWG.HTML.Attribute.ReferrerPolicy? = nil,
            nomodule: WHATWG.HTML.Attribute.Nomodule? = nil,
            ...
            nonce: WHATWG.HTML.Attribute.Nonce? = nil,
            attributionsrc: WHATWG.HTML.Attribute.AttributionSrc? = nil
        ) {
            self.src = src
            self.async = async
            self.defer = `defer`
...
extension WHATWG.HTML.Element.Script {
    /// The HTML tag name
    ...
    public static let content: WHATWG.HTML.Element.Content = .init(model: .text)
}
