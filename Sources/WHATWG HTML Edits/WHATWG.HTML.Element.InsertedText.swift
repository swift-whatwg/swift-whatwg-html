...
extension WHATWG.HTML.Element {
    ...
    ///
    public struct InsertedText: WHATWG.HTML.Element.`Protocol` {
        /// The URI of a resource that explains the change, such as a link to meeting minutes or a ticket.
        public var cite: WHATWG.HTML.Attribute.Cite?

        /// Indicates the time and date of the change.
        public var datetime: WHATWG.HTML.Attribute.DateTime?
        ...
        public init(
            cite: WHATWG.HTML.Attribute.Cite? = nil,
            datetime: WHATWG.HTML.Attribute.DateTime? = nil
        ) {
            self.cite = cite
...
extension WHATWG.HTML.Element.InsertedText {
    /// The HTML tag name
