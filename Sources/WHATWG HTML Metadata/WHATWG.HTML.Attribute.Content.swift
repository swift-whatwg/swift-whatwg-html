...
extension WHATWG.HTML.Attribute {
    ...
    @dynamicMemberLookup public struct Content: WHATWG.HTML.StringAttribute {
...
extension WHATWG.HTML.Attribute.Content {
    @inlinable public static var attribute: String { "content" }
}

extension WHATWG.HTML.Attribute.Content: CustomStringConvertible {
    public var description: String { rawValue }
}

extension WHATWG.HTML.Attribute.Content: ExpressibleByStringLiteral {
    public init(stringLiteral value: String) { self.init(value: value) }
}

extension WHATWG.HTML.Attribute.Content: RawRepresentable {
