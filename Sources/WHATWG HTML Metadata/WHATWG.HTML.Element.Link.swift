...
extension WHATWG.HTML.Element {
    ...
    public struct Link: WHATWG.HTML.Element.`Protocol` {
        ...
        public var fetchpriority: WHATWG.HTML.Attribute.FetchPriority?

        /// Specifies the URL of the linked resource.
        public var href: WHATWG.HTML.Attribute.Href?

        /// Indicates the language of the linked resource.
        public var hreflang: WHATWG.HTML.Attribute.Hreflang?

        /// For preloaded images, has similar syntax and semantics as the sizes attribute.
        public var imagesizes: WHATWG.HTML.Attribute.ImageSizes?

        /// For preloaded images, has similar syntax and semantics as the srcset attribute.
        public var imagesrcset: WHATWG.HTML.Attribute.ImageSrcSet?
        ...
        public var integrity: WHATWG.HTML.Attribute.Integrity?
        ...
        public var media: WHATWG.HTML.Attribute.Media?

        /// Controls which referrer is sent when fetching the resource.
        public var referrerpolicy: WHATWG.HTML.Attribute.ReferrerPolicy?
        ...
        public var rel: WHATWG.HTML.Attribute.Rel?
        ...
        public init(
            `as`: WHATWG.HTML.Attribute.As? = nil,
            blocking: WHATWG.HTML.Attribute.Blocking? = nil,
            crossorigin: WHATWG.HTML.Attribute.Crossorigin? = nil,
            disabled: WHATWG.HTML.Attribute.Disabled? = nil,
            fetchpriority: WHATWG.HTML.Attribute.FetchPriority? = nil,
            href: WHATWG.HTML.Attribute.Href? = nil,
            hreflang: WHATWG.HTML.Attribute.Hreflang? = nil,
            imagesizes: WHATWG.HTML.Attribute.ImageSizes? = nil,
            imagesrcset: WHATWG.HTML.Attribute.ImageSrcSet? = nil,
            integrity: WHATWG.HTML.Attribute.Integrity? = nil,
            media: WHATWG.HTML.Attribute.Media? = nil,
            referrerpolicy: WHATWG.HTML.Attribute.ReferrerPolicy? = nil,
            rel: WHATWG.HTML.Attribute.Rel? = nil,
            sizes: WHATWG.HTML.Attribute.Sizes? = nil,
            title: WHATWG.HTML.Attribute.Title? = nil,
            type: WHATWG.HTML.Attribute.LinkType? = nil
        ) {
            self.`as` = `as`
...
extension WHATWG.HTML.Element.Link {
    @inlinable public static var tag: String { "link" }
    public static let categories: Set<WHATWG.HTML.Element.Content.Category> = [.metadata]
