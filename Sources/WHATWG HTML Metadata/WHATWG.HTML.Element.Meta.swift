...
extension WHATWG.HTML.Element {
    ...
    public struct Meta: WHATWG.HTML.Element.`Protocol` {
        ...
        public var charset: WHATWG.HTML.Attribute.CharSet?
        ...
        public var content: WHATWG.HTML.Attribute.Content?
        ...
        public var httpEquiv: WHATWG.HTML.Attribute.HttpEquiv?
        ...
        public var name: WHATWG.HTML.Attribute.MetaName?
        ...
        ///   - name: Metadata name
        public init(
            charset: WHATWG.HTML.Attribute.CharSet? = nil,
            content: WHATWG.HTML.Attribute.Content? = nil,
            httpEquiv: WHATWG.HTML.Attribute.HttpEquiv? = nil,
            media: WHATWG.HTML.Attribute.Media? = nil,
            name: WHATWG.HTML.Attribute.MetaName? = nil
        ) {
        ...
        public init(
            name: WHATWG.HTML.Attribute.MetaName,
            content: WHATWG.HTML.Attribute.Content,
            media: WHATWG.HTML.Attribute.Media? = nil
        ) {
            self.name = name
            self.content = content
        ...
        public init(
            httpEquiv: WHATWG.HTML.Attribute.HttpEquiv,
            content: WHATWG.HTML.Attribute.Content
        ) {
            self.httpEquiv = httpEquiv
            self.content = content
...
extension WHATWG.HTML.Element.Meta {
...
extension WHATWG.HTML.Element.Meta {
    ...
    public static let utf8 = WHATWG.HTML.Element.Meta(charset: "utf-8")

    /// Creates a meta element for responsive viewport.
    public static let viewport = WHATWG.HTML.Element.Meta(
        name: .viewport,
    ...
    public static func openGraph(
        property: String,
        content: WHATWG.HTML.Attribute.Content
    ) -> WHATWG.HTML.Element.Meta {
        return WHATWG.HTML.Element.Meta(name: .init(stringLiteral: property), content: content)
    }
}
