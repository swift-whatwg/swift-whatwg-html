...
extension WHATWG.HTML.Element {
    ...
    ///
    public struct InlineQuotation: WHATWG.HTML.Element.`Protocol` {
        ...
        public init(cite: WHATWG.HTML.Attribute.Cite? = nil) {
            self.cite = cite
...
extension WHATWG.HTML.Element.InlineQuotation {
    /// The HTML tag name
