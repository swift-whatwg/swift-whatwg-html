...
extension WHATWG.HTML.Element {
    ...
    public struct BidirectionalTextOverride: WHATWG.HTML.Element.`Protocol` {

        /// The required direction attribute for the bidirectional text override element
        public let dir: WHATWG.HTML.Attribute.Dir
        ...
        public init(dir: WHATWG.HTML.Attribute.Dir) { self.dir = dir }
    }
}

extension WHATWG.HTML.Element.BidirectionalTextOverride {
    /// The HTML tag name
