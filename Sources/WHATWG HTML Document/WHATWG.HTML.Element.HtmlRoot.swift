...
extension WHATWG.HTML.Element {
    ...
    ///
    public struct HtmlRoot: WHATWG.HTML.Element.`Protocol` {
        /// The XML namespace of the document (required for XHTML)
        public var xmlns: WHATWG.HTML.Attribute.Xmlns?
        ...
        public init(xmlns: WHATWG.HTML.Attribute.Xmlns? = nil) {
            self.xmlns = xmlns
...
extension WHATWG.HTML.Element.HtmlRoot {
    /// The HTML tag name
