...
extension WHATWG.HTML.Element {
    ...
    public struct Base: WHATWG.HTML.Element.`Protocol` {
        ...
        public init(href: WHATWG.HTML.Attribute.Href) { self.configuration = .href(href) }

        /// Creates a new Base element with a target attribute.
        ///
        /// - Parameter target: The default browsing context for navigation.
        public init(target: WHATWG.HTML.Attribute.Target) { self.configuration = .target(target) }
        ...
        public init(href: WHATWG.HTML.Attribute.Href, target: WHATWG.HTML.Attribute.Target) {
            self.configuration = .both(href: href, target: target)
        }
    }
}

extension WHATWG.HTML.Element.Base {
    ...
    public enum Configuration: Sendable, Hashable {
        ...
        case href(WHATWG.HTML.Attribute.Href)

        /// A base element with only a target attribute.
        case target(WHATWG.HTML.Attribute.Target)

        /// A base element with both href and target attributes.
        case both(href: WHATWG.HTML.Attribute.Href, target: WHATWG.HTML.Attribute.Target)
    }
