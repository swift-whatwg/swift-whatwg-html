...
extension WHATWG.HTML.Element {
    ...
    public struct InlineFrame: WHATWG.HTML.Element.`Protocol` {
        ...
        public var allowfullscreen: WHATWG.HTML.Attribute.Allowfullscreen?

        /// Specifies a Permissions Policy for the iframe
        public var allow: WHATWG.HTML.Attribute.Allow?
        ...
        public init(
            ...
            sandbox: String? = nil,
            allowfullscreen: WHATWG.HTML.Attribute.Allowfullscreen? = nil,
            allow: WHATWG.HTML.Attribute.Allow? = nil,
...
extension WHATWG.HTML.Element.InlineFrame {
    /// The HTML tag name
