...
extension WHATWG.HTML.Element {
    ...
    public struct Area: WHATWG.HTML.Element.`Protocol` {
        ...
        public var download: WHATWG.HTML.Attribute.Download?
        ...
        public var ping: WHATWG.HTML.Attribute.Ping?
        ...
        public var target: WHATWG.HTML.Attribute.Target?
        ...
        public init(
            ...
            download: WHATWG.HTML.Attribute.Download? = nil,
            ping: WHATWG.HTML.Attribute.Ping? = nil,
            referrerpolicy: WHATWG.HTML.Attribute.ReferrerPolicy? = nil,
            rel: WHATWG.HTML.Attribute.Rel? = nil,
            target: WHATWG.HTML.Attribute.Target? = nil
        ) {
            self.shape = shape
            self.alt = alt
            self.href = href
        ...
        public init(
            shape: Shape,
            href: WHATWG.HTML.Attribute.Href,
            alt: WHATWG.HTML.Attribute.Alt,
            target: WHATWG.HTML.Attribute.Target? = nil
        ) {
            self.shape = shape
            self.href = href
...
extension WHATWG.HTML.Element.Area {
...
extension WHATWG.HTML.Element.Area.Shape {
...
extension WHATWG.HTML.Element.Area {
    ...
    public static func rectangle(
        ...
        alt: WHATWG.HTML.Attribute.Alt,
        target: WHATWG.HTML.Attribute.Target? = nil
    ) -> WHATWG.HTML.Element.Area {
        let coords = "\(x1),\(y1),\(x2),\(y2)"
        return WHATWG.HTML.Element.Area(
    ...
    public static func defaultArea(
        ...
        return WHATWG.HTML.Element.Area(shape: .default, href: href, alt: alt, target: target)
    }
}
