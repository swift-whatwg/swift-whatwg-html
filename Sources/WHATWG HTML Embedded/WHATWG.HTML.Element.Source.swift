...
extension WHATWG.HTML.Element {
    ...
    ///
    public struct Source: WHATWG.HTML.Element.`Protocol` {
        /// The MIME media type of the resource
        public var type: WHATWG.HTML.Attribute.SourceType?
        ...
        public var srcset: WHATWG.HTML.Attribute.ImageSrcSet?
        ...
        public init(
            type: WHATWG.HTML.Attribute.SourceType? = nil,
            src: WHATWG.HTML.Attribute.Src? = nil,
            srcset: WHATWG.HTML.Attribute.ImageSrcSet? = nil,
...
extension WHATWG.HTML.Element.Source {
    /// The HTML tag name
