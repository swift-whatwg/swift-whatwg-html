...
extension WHATWG.HTML.Element {
    ...
    public struct Track: WHATWG.HTML.Element.`Protocol` {
        ...
        public init(
            default: WHATWG.HTML.Attribute.Default? = nil,
            kind: WHATWG.HTML.Attribute.Kind? = nil,
            src: WHATWG.HTML.Attribute.Src,
            srclang: WHATWG.HTML.Attribute.SrcLang? = nil,
            label: WHATWG.HTML.Attribute.Label? = nil
        ) {
...
extension WHATWG.HTML.Element.Track {
    /// The HTML tag name
