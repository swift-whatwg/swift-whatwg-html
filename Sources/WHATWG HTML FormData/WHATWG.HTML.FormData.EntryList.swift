...
extension WHATWG.HTML.Element.Form.Data.Entry {
    ...
    public struct List: Sendable {
        ...
        @usableFromInline internal private(set) var entries: [WHATWG.HTML.Element.Form.Data.Entry]
        ...
        @inlinable public init(entries: [WHATWG.HTML.Element.Form.Data.Entry]) {
            self.entries = entries
        }
    }
}

extension WHATWG.HTML.Element.Form.Data.Entry.List {
    /// Appends an entry to the list.
    ///
    /// - Parameter entry: The entry to append
    @inlinable public mutating func append(_ entry: WHATWG.HTML.Element.Form.Data.Entry) {
    ...
    @inlinable public mutating func append(name: String, value: WHATWG.HTML.Element.Form.Data.Value)
    {
        append(WHATWG.HTML.Element.Form.Data.Entry(name: name, value: value))
    }
    ...
    @inlinable public mutating func append(name: String, value: String) {
        append(WHATWG.HTML.Element.Form.Data.Entry(name: name, value: .string(value)))
    }
    ...
    ///   - name: The entry name
    ///   - file: The file value
    @inlinable public mutating func append(name: String, file: WHATWG.HTML.Element.Form.Data.File) {
        append(WHATWG.HTML.Element.Form.Data.Entry(name: name, value: .file(file)))
    }
    ...
    @inlinable public subscript(name: String) -> [WHATWG.HTML.Element.Form.Data.Value]? {
    ...
    @inlinable public func first(named name: String) -> WHATWG.HTML.Element.Form.Data.Value? {
    ...
    @inlinable public func all(named name: String) -> [WHATWG.HTML.Element.Form.Data.Value] {
...
extension WHATWG.HTML.Element.Form.Data.Entry.List: Swift.Collection {
    public typealias Index = Array<WHATWG.HTML.Element.Form.Data.Entry>.Index
    public typealias Element = WHATWG.HTML.Element.Form.Data.Entry

    @inlinable public var startIndex: Index { entries.startIndex }

    @inlinable public var endIndex: Index { entries.endIndex }

    @inlinable public subscript(position: Index) -> WHATWG.HTML.Element.Form.Data.Entry {
        entries[position]
    }
...
extension WHATWG.HTML.Element.Form.Data.Entry.List: Swift.Sequence {
    @inlinable public func makeIterator() -> Array<WHATWG.HTML.Element.Form.Data.Entry>.Iterator {
...
extension WHATWG.HTML.Element.Form.Data.Entry.List: ExpressibleByArrayLiteral {
    @inlinable public init(arrayLiteral elements: WHATWG.HTML.Element.Form.Data.Entry...) {
...
extension WHATWG.HTML.Element.Form.Data.Entry.List: Equatable {
    @inlinable public static func == (lhs: Self, rhs: Self) -> Bool { lhs.entries == rhs.entries }
}

extension WHATWG.HTML.Element.Form.Data.Entry.List: Hashable {
    @inlinable public func hash(into hasher: inout Hasher) { hasher.combine(entries) }
}

// MARK: - CustomStringConvertible

extension WHATWG.HTML.Element.Form.Data.Entry.List: CustomStringConvertible {
...
extension WHATWG.HTML.Element.Form.Data.Entry.List: CustomDebugStringConvertible {
    public var debugDescription: String {
        """
        WHATWG.HTML.Element.Form.Data.Entry.List(count: \(count)) {
