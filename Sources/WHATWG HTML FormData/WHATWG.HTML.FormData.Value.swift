...
extension WHATWG.HTML.Element.Form.Data {
    ...
    /// ```swift
    /// // String value
    /// let stringValue: WHATWG.HTML.Form.Data.Value = .string("Hello")
    ///
    /// // File value
...
extension WHATWG.HTML.Element.Form.Data.Value {
    ...
    @inlinable public var fileValue: WHATWG.HTML.Element.Form.Data.File? {
...
extension WHATWG.HTML.Element.Form.Data.Value: ExpressibleByStringLiteral {
    @inlinable public init(stringLiteral value: String) { self = .string(value) }
}

// MARK: - CustomStringConvertible

extension WHATWG.HTML.Element.Form.Data.Value: CustomStringConvertible {
