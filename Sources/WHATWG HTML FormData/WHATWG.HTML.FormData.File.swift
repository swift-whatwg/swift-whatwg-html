...
extension WHATWG.HTML.Element.Form.Data {
    ...
    ///
    /// ```swift
    /// let imageFile = WHATWG.HTML.Form.Data.File(
    ///     name: "profile.jpg",
    ///     type: "image/jpeg",
    ///     body: jpegData
    /// )
    ///
    /// let pdfFile = WHATWG.HTML.Form.Data.File(
    ///     name: "document.pdf",
...
extension WHATWG.HTML.Element.Form.Data.File {
...
extension WHATWG.HTML.Element.Form.Data.File: CustomStringConvertible {
...
extension WHATWG.HTML.Element.Form.Data.File.MIMEType {
    /// Plain text files
